public class Notebook {
    ...
    public Notebook(String tipoDispositivo, String produttore, String modello, String descrizione, double dimensioneDisplay, int spazioArchiviazione, double prezzoAcquisto, double prezzoVendita, int idDispositivo) {
