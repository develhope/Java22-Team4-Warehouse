public class Tablet {
    ...
    public Tablet(String tipoDispositivo, String produttore, String modello, String descrizione, double dimensioneDisplay, int spazioArchiviazione, double prezzoAcquisto, double prezzoVendita, int idDispositivo) {
