public class Tablet {
    ...
    private int idDispositivo;  // Id univoco del dispositivo nel magazzino

    public Tablet(String tipoDispositivo, String produttore, String modello, String descrizione,
